...
TVMMainEntry VMLoadModule(const char *module);//added from utils

void VMAlarmCallBack(void* calldata);//added function
void VMFileCallBack(void* calldata, int result);//added function
void VMThreadEntry(void *param);//added function
void VMScheduler();//added function
...
volatile int globalFileFlag;
void *sharedData;//base of shared memory space
